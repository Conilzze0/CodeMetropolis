...
### Pull Request
The developer must create a pull request in order to merge back the code change
...
## Quality Gates
### Testing
This project contains **JUnit** to ensure the correctness of the codebase and **functional Python tests**
...
The reports generated by the tools listed above can be found attached to each pull request.
